<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="editdetails.aspx.cs" Inherits="TestProject.editdetails" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>NIE | Update Details</title>
...
<body >
    ...
    <h3 align="center">UPDATE THE DETAILS</h3>
   
    <form id="regForm" runat="server">
        
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                <img src="edit.jpg" id="myImage" class="col-lg-12 col-md-12 col-sm-12 col-xs-12"/>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <input type="text" id="em" name="email" runat="server" class="form-control" readonly="TRUE"/><br>
                    ...
                    <input type="text" id="dpt" name="department" runat="server" class="form-control"/><br>

                    <label for="password">Password:<span>*</span></label>
                    <input type="text" id="pswd" name="password" runat="server" class="form-control"/><br>

                    <asp:Button ID="updatedata" runat="server"  CssClass="btn btn-success btn" OnClick="Updatedata_Click" Text="Update User Info" OnClientClick="return validateForm();" />
